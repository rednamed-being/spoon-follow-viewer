...
const mockFollowersData = {
  ...
  results: [
    ...
    {
      id: 317118204,
      nickname: "spooner9118703290",
      tag: "nr8qqj7m",
      top_impressions: [],
      description: "",
      profile_url:
        "https://profile.line-scdn.net/0hRa36wKRMDU4eTxvFKexzMW4fDiQ9PlRcZSoXey9PUS53fB8aNCxDKnlKBikleEsYMClDIXtOAXwSXHooABnxehl_U3kkf0oRNClBoA",
      gender: 1,
      follow_status: 0,
      follower_count: 38,
      following_count: 2360,
      is_active: true,
      is_staff: false,
      is_vip: false,
      date_joined: "2025-06-05T10:18:23.317000Z",
      current_live: null,
      country: "jp",
      is_verified: false,
    },
    {
      ...
      description: "23:00辺り🦆",
      profile_url:
        "http://jp-cdn.spooncast.net/profiles/j/nALVejWTObJarM/f391cdff-ae7b-489f-995c-56223cabcbd8.jpg",
      gender: 0,
      follow_status: 0,
      follower_count: 400,
      following_count: 18,
      ...
      is_staff: false,
      is_vip: false,
      date_joined: "2024-01-27T13:45:40.035188Z",
      current_live: null,
      country: "jp",
      is_verified: false,
    },
...
export async function GET(
  ...
  try {
    ...
    if (useMock) {
      console.log(`[MOCK] フォロワー情報を取得中: ユーザーID ${userId}`);
      await new Promise((resolve) => setTimeout(resolve, 1000));
      return NextResponse.json(mockFollowersData);
    }

    console.log(`[REAL API] フォロワー情報を取得開始: ユーザーID ${userId}`);
    ...
    console.error("[ERROR] フォロワー取得エラー:", error);
    return NextResponse.json(
      {
        error: "フォロワー情報の取得に失敗しました",
